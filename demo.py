...
__updated__ = '2022-11-10 17:46:01'
          ...
          for res in data_yama['response']['results']: # Open Onoyama dictionary by loop
               ...
               for alt in res['alternatives']:    # Open alternatives, key before transcript for Onoyama             
                    ...
                    if len(alt_1['transcript']) <= 9:
                         ...
                         tolerance = 10
                    time_tole = 50
                    # time_diff = alt['words'][0]['startTime'] - alt_1['words'][0]['startTime']     # reduce error by using time difference     
                    ...
                    alt_1['transcript_split'] = transcript_split_word[mini_value] # Recording of content in dictionary, json file
