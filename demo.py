...
yama = open(path_yama, 'r', encoding='utf-8-sig')    # read json file, voice of Onoyama
data_yama = json.load(yama, strict=False)    # return data in dict
print(type(data_yama))

All = open(path_all,encoding='utf-8-sig', errors='ignore')
          ...
          for res_1 in data_wata_1['response']['results']:
                    ...
                    for alt_1 in res_1['alternatives']:
                         ...
                         if alt_1['transcript'] == alt['transcript']:
                              ...
                              path_yama_new = open(path_yama + '_new.json', 'a')
                              json.dump(alt, path_yama_new)
